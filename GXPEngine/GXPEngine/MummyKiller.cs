...
public class MummyKiller: AnimationSprite
{
    ...
    Sound rawSound = new Sound("mummyraw.wav");
    //----------------------------------------------------------------------------------------
    //                                        Constructor
    //----------------------------------------------------------------------------------------
    /// <summary>
    ...
    /// </summary>
    #region Constructor
    public MummyKiller(string filename, int cols, int rows, TiledObject obj) : base(filename, cols, rows)
    {
